...
export function StorageHeader({ hasUnsavedChanges, hasValidationError, isScanning, onSave, onScan }: StorageHeaderProps) {
  return (
    <header className="storage-heading">
      ...
      <div className="storage-heading-actions">
        <button className="save-changes-button" disabled={!hasUnsavedChanges || hasValidationError || isScanning} onClick={onSave}><Save />Save Changes</button>
